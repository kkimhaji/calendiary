...
public class TeamInviteController {
    ...
    public ResponseEntity<InviteResponse> createInvite(@RequestBody InviteCreateRequest request, @PathVariable("teamId") @P("teamId") Long teamId){
        return ResponseEntity.ok(teamInviteService.createInvite(request, teamId));
    }
